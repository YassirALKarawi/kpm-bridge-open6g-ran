...
- [ ] Both authors confirm the final title, spelling, order, affiliations, and
      corresponding-author designation.
- [ ] Both authors approve the final manuscript and confirm originality,
      authorship, conflicts/funding disclosures, and no simultaneous submission.
- [ ] Both authors link valid ORCID records to their ScholarOne accounts; IEEE
